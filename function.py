...
def get_doc_owner_name(num_d):
    user_doc_number = num_d
    # print()
...
def add_new_doc(type_doc,num_doc ,name, num_shelf):
    new_doc_number = num_doc
    new_doc_type = type_doc
    new_doc_owner_name = name
    new_doc_shelf_number = num_shelf
    new_doc = {
        "type": new_doc_type,
...
def secretary_program_start():
    ...
    while True:
        ...
        if user_command == 'p':
            owner_name = get_doc_owner_name('2207 876234')
